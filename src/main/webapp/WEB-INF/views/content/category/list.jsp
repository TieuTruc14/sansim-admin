...
<script src="<%=request.getContextPath()%>/assets/project/content/category/list.js"></script>
                ...
                <div class="text-sm wrapper bg-light lt">
                    <form cssClass="form-inline padder" action="list" role="form" theme="simple">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <label class="col-sm-4 control-label">Tên chuyên mục</label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group text-center">
                            ...
                            <sec:authorize access="hasRole('ROLE_CONTENT_CATEGORY_ADD')">
                                <a class="btn btn-sm btn-primary pull-right"
                                   href="<%=request.getContextPath()%>/content/category/add"><i class="fa fa-plus"></i> Thêm mới</a>
                            </sec:authorize>
                        </div>
                    </form>
                </div>
                ...
                <div class="table-responsive table-overflow-x-fix">
                    <table id="tbl" class="table table-striped table-bordered m-b-none text-sm">
                        ...
                        <tr>
                            ...
                            <th class="box-shadow-inner small_col text-center">Tên chuyên mục</th>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <sec:authorize access="hasAnyRole('ROLE_CONTENT_CATEGORY_EDIT')">
                                            <li><a href="<%=request.getContextPath()%>/content/category/edit/{{item.id}}"><i class="fa fa-pencil-square-o"></i>Sửa</a></li>
                                        </sec:authorize>
    ...
    <div class="modal fade"  id="deleteItem"  role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog" style="max-width: 500px;">
            <div class="modal-content"style="max-width: 500px;">
                ...
                <form id="filter" method="POST"  action="<%=request.getContextPath()%>/content/category/delete" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
