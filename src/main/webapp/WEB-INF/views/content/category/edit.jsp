        ...
        <section class="scrollable padder">
            ...
            <section class="panel panel-default">
                ...
                <div class="panel-body" style="min-height: 600px;">
                    <form method="post" action="<%=request.getContextPath()%>/content/category/edit" theme="simple"  enctype="multipart/form-data" class="form-horizontal" cssStyle="" validate="true">
                        <div class="form-group">
                            <input name="id" maxlength="100" style="width:100%;" value="${item.id}"
                                   placeholder="" class="form-control" type="hidden"/>
                            <label class="col-sm-2 control-label" style="line-height: 30px">Tên chuyên mục<span style="color: red">*</span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-5">
                                <a href="<%=request.getContextPath()%>/content/category/list" class="btn btn-default">Hủy bỏ</a>
