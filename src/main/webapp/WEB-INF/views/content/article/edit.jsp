        ...
        <section class="scrollable padder">
            ...
            <section class="panel panel-default">
                ...
                <div class="panel-body" style="min-height: 600px;">
                    <form method="post" action="<%=request.getContextPath()%>/content/article/edit" theme="simple"  enctype="multipart/form-data" class="form-horizontal" cssStyle="" validate="true">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group m-b">
                                    ...
                                    <textarea name="shortContent" placeholder="" maxlength="200" value="${item.shortContent}" style="width:100%;" class="form-control">${item.shortContent}</textarea>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                 <textarea id="contentnews" name="content" class="ckeditor" cols="80" rows="10">${item.content}
                                 </textarea>
