                            ...
                            <div class="col-md-6">
                                ...
                                <sec:authorize access="hasRole('ROLE_CATEGORY_GROUP_PRICE_ADD')">
                                    <a class="btn btn-sm btn-primary pull-right"
                                       href="<%=request.getContextPath()%>/category/group-price/add"><i class="fa fa-plus"></i> Thêm mới</a>
                                </sec:authorize>
                            </div>
                        </div>
                ...
                <div class="table-responsive table-overflow-x-fix">
                    <table id="tblUser" class="table table-striped table-bordered m-b-none text-sm">
                        ...
                        <tr>
                            ...
                            <th class="box-shadow-inner small_col text-center">Mức giá min</th>
                            <th class="box-shadow-inner small_col text-center">Mức giá max</th>
                        ...
                        <tr ng-repeat="item in page.items track by $index">
                            ...
                            <td class="align-center">{{item.min|currency:"":0}}</td>
                            <td class="align-center">{{item.max|currency:"":0}}</td>
    ...
    <div class="modal fade"  id="deleteItem"  role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog" style="max-width: 500px;">
            <div class="modal-content"style="max-width: 500px;">
                ...
                <form id="filter" method="POST"  action="<%=request.getContextPath()%>/category/group-price/delete" theme="simple" enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="false">
                    <div class="modal-body"  style="padding: 10px;">
                        <div class="form-group">
