...
<script src="<%=request.getContextPath()%>/assets/project/report/general.sale.sms.js"></script>
                    ...
                    <form cssClass="form-inline padder" action="list" role="form" theme="simple">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-8">
                                    <select name="type" class="select2-option" id="active-select" style="min-width:200px" ng-model="type">
                                        ...
                                        <%--<option value="5">Hủy do hệ thống</option>--%>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="form-group ">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-8">
                                    <%--<input class="input-sm input-s datepicker-input form-control" size="10" data-date-format="dd/mm/yyyy" ng-model="date.from" my-enter="search()" name="from"  onkeypress="return restrictCharacters(this, event, digitsAndSlash);" />--%>
                                    <input class="input-sm input-s datepicker-input form-control" size="10" data-date-format="dd/mm/yyyy" my-enter="search()" id="from"  onkeypress="return restrictCharacters(this, event, digitsAndSlash);" />
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-8">
                                    <input class="input-sm input-s datepicker-input form-control" size="10" data-date-format="dd/mm/yyyy" type="text" my-enter="search()" id="to"  onkeypress="return restrictCharacters(this, event, digitsAndSlash);" />
                        ...
                        <div class="form-group text-center">
                            ...
                            <a ng-if="page.items.length>0" ng-click="download()" class="btn btn-primary btn-sm" style="float:right"><i class="fa fa-download"></i>Tải file excel</a>
                        </div>
                ...
                <div class="table-responsive table-overflow-x-fix">
                    <table id="tbl" class="table table-striped table-bordered m-b-none text-sm">
                        ...
                        <tr>
                            ...
                            <th class="box-shadow-inner small_col text-center">Doanh thu</th>
                        </tr>
                        </thead>
                        <tbody>
