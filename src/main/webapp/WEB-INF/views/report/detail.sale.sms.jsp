...
<script src="<%=request.getContextPath()%>/assets/project/report/detail.sale.sms.js"></script>
    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="javascript:void(0)">Chi tiết doanh thu sms</a></li>
            </ul>
            <div class="m-b-md">
                    ...
                    <form cssClass="form-inline padder" action="list" role="form" theme="simple">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-8">
                                    <select name="type" class="select2-option" id="active-select" style="min-width:200px" ng-model="type" ng-change="changeType(type)">
                            ...
                            <div class="col-md-6" ng-show="show">
                                <label class="col-sm-4 control-label">Giao dịch</label>
                                <div class="col-sm-8">
                                    <select name="packageId" class="select2-option" id="active-select1" style="min-width:200px" ng-model="packageId" >
                                        <option value="">Tất cả</option>
                ...
                <div class="table-responsive table-overflow-x-fix">
                    <table id="tbl" class="table table-striped table-bordered m-b-none text-sm">
                        ...
                        <tr>
                            ...
                            <th class="box-shadow-inner small_col text-center">Giao dịch</th>
                            ...
                            <th class="box-shadow-inner small_col text-left">Doanh thu</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr ng-repeat="item in page.items track by $index">
                            ...
                            <td class="align-center" ng-switch on="item[0]">
                                <span ng-switch-when="1">Đăng ký gói {{item[5]}}</span>
                                <span ng-switch-when="2">Gia hạn gói {{item[5]}}</span>
                                <span ng-switch-when="3">Xác thực số</span>
                                <span ng-switch-when="4">Gia hạn xác thực</span>
                                <%--<span ng-switch-when="5">Hủy</span>--%>
                                <span ng-switch-default >Chưa xác định</span>
