...
<script src="<%=request.getContextPath()%>/assets/project/report/crud.msisdn.js"></script>
    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="javascript:void(0)">Thêm và xóa số</a></li>
            </ul>
            <div class="m-b-md">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-8">
                                    <select name="type" class="select2-option" id="active-select" style="min-width:200px" ng-model="type">
                                        ...
                                        <option value="1">Số đăng mới</option>
                                        <option value="0">Số bị xóa</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="table-responsive table-overflow-x-fix">
                    <table id="tbl" class="table table-striped table-bordered m-b-none text-sm">
                        ...
                        <tr>
                            ...
                            <th class="box-shadow-inner small_col text-center">Loại số</th>
                        ...
                        <tr ng-repeat="item in page.items track by $index">
                            ...
                            <td class="align-center" ng-switch on="item[0]">
                                <span ng-switch-when="1">Đăng ký mới</span>
                                <span ng-switch-when="0">Số bị xóa</span>
