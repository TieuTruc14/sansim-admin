    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="javascript:void(0)">Sửa gói phí số</a></li>
            </ul>
            <div class="m-b-md">
                <h3 class="m-b-none">Sửa gói phí số: ${item.packageCode}</h3><br/>
                <span style="color:red">${messageError}</span>
            </div>

            <section class="panel panel-default">
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i>Sửa gói phí số</header>
                <div class="panel-body" style="min-height: 600px;">
                    <form method="post" action="<%=request.getContextPath()%>/administer/package/edit" theme="simple"  enctype="multipart/form-data" class="form-horizontal" cssStyle="" validate="true">

                        <div class="line line-dashed line-lg pull-in"></div>
                        <input name="id" maxlength="50" style="width:100%;" value="${item.id}" type="hidden" class="form-control"/>
                        <input name="packageCode" type="hidden" maxlength="50" style="width:100%;" value="${item.packageCode}"
